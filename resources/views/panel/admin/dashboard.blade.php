                                ...
                                @foreach($order_data as $data)
                                    ...
                                    <div class="timeline-item">
                                        <div class="timeline-item-marker">
                                            <div class="timeline-item-marker-text">{{ $data->created_at->diffForHumans() }}</div>
                                            <div
                                        ...
                                        <div class="timeline-item-content">
                                            Order placed!
                                            <a class="fw-bold text-dark" href="#!">Order #{{ $data->id ?? '' }}</a>
                                            has been placed, status is <b>{{ ucfirst($data->status) ?? '' }}</b>.
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-xl-3 mb-4">
                            <div class="card bg-primary text-white h-100">
                                ...
                                >
                                    <a class="text-white stretched-link" href="{{ route('categories.index') }}"
                                    >View Categories</a
                                    >
                        ...
                        <div class="col-lg-6 col-xl-3 mb-4">
                            <div class="card bg-primary text-white h-100">
                                ...
                                <div
                                    class="card-footer d-flex align-items-center justify-content-between small"
                                >
                                    <a class="text-white stretched-link" href="{{ route('products.index') }}"
                                    >View Products</a
                                    >
                                    <div class="text-white">
                                        <i class="fas fa-angle-right"></i>
                                ...
                                <div class="card-body">
                                    ...
                                    >
                                        <div class="me-3">
                                            ...
                                            <div class="text-lg fw-bold">{{ $suppliers_count }}</div>
                                        </div>
                                    </div>
                                </div>
                                <div
                                    class="card-footer d-flex align-items-center justify-content-between small"
                                >
                                    <a class="text-white stretched-link" href="{{ route('suppliers.index') }}"
                                    >View Suppliers</a
                                    >
                                    <div class="text-white">
                                        <i class="fas fa-angle-right"></i>
                                ...
                                <div class="card-body">
                                    ...
                                    >
                                        <div class="me-3">
                                            ...
                                            <div class="text-lg fw-bold">{{ $warehouses_count }}</div>
                                        </div>
                                    </div>
                                </div>
                                <div
                                    class="card-footer d-flex align-items-center justify-content-between small"
                                >
                                    <a class="text-white stretched-link" href="{{ route('warehouses.index') }}"
                                    >View Warehouses</a
                                    >
                                    <div class="text-white">
                                        <i class="fas fa-angle-right"></i>
                        ...
                        <div class="col-lg-6 col-xl-3 mb-4">
                            <div class="card bg-primary text-white h-100">
                                ...
                                <div
                                    class="card-footer d-flex align-items-center justify-content-between small"
                                >
                                    <a class="text-white stretched-link" href="{{ route('inventories.index') }}"
                                    >View Inventories</a
                                    >
                                    <div class="text-white">
                                        <i class="fas fa-angle-right"></i>
                        ...
                        <div class="col-lg-6 col-xl-3 mb-4">
                            <div class="card bg-primary text-white h-100">
                                ...
                                <div
                                    class="card-footer d-flex align-items-center justify-content-between small"
                                >
                                    <a class="text-white stretched-link" href="{{ route('user_management.index') }}"
                                    >View Users</a
                                    >
                                    <div class="text-white">
                                        <i class="fas fa-angle-right"></i>
                        ...
                        <div class="col-lg-6 col-xl-3 mb-4">
                            <div class="card bg-primary text-white h-100">
                                ...
                                <div
                                    class="card-footer d-flex align-items-center justify-content-between small"
                                >
                                    <a class="text-white stretched-link" href="{{ route('admin.view_order.index') }}"
                                    >View Orders</a
                                    >
                                    <div class="text-white">
                                        <i class="fas fa-angle-right"></i>
