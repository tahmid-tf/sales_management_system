                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-xl-3 mb-4">
                            <div class="card bg-primary text-white h-100">
                                ...
                                >
                                    <a class="text-white stretched-link" href="{{ route('staff.category.index') }}"
                                    >View Categories</a
                                    >
                        ...
                        <div class="col-lg-6 col-xl-3 mb-4">
                            <div class="card bg-primary text-white h-100">
                                ...
                                <div
                                    class="card-footer d-flex align-items-center justify-content-between small"
                                >
                                    <a class="text-white stretched-link" href="{{ route('staff.products.index') }}"
                                    >View Products</a
                                    >
                                    <div class="text-white">
                                        <i class="fas fa-angle-right"></i>
                        ...
                        <div class="col-lg-6 col-xl-3 mb-4">
                            <div class="card bg-primary text-white h-100">
                                ...
                                <div
                                    class="card-footer d-flex align-items-center justify-content-between small"
                                >
                                    <a class="text-white stretched-link" href="{{ route('staff.inventory.index') }}"
                                    >View Inventories</a
                                    >
                                    <div class="text-white">
                                        <i class="fas fa-angle-right"></i>
                        ...
                        <div class="col-lg-6 col-xl-3 mb-4">
                            <div class="card bg-primary text-white h-100">
                                ...
                                <div
                                    class="card-footer d-flex align-items-center justify-content-between small"
                                >
                                    <a class="text-white stretched-link" href="{{ route('staff.view_order.index') }}"
                                    >View Orders</a
                                    >
                                    <div class="text-white">
                                        <i class="fas fa-angle-right"></i>
